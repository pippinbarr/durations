...
class MilleniumGuitarist extends FlxSprite
{
	...
	public function new (X:Float,Y:Float,UserControlled:Bool = false):Void
	{
		...
		aNote = new FlxSound();
		aNote.loadEmbedded(GameAssets.GUITAR_A,true);
		bNote = new FlxSound();
		bNote.loadEmbedded(GameAssets.GUITAR_B,true);
		dNote = new FlxSound();
		dNote.loadEmbedded(GameAssets.GUITAR_D,true);
		eNote = new FlxSound();
		eNote.loadEmbedded(GameAssets.GUITAR_E,true);
		fNote = new FlxSound();
		fNote.loadEmbedded(GameAssets.GUITAR_F,true);
